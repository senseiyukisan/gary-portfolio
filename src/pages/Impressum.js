...
const ImprintPage = () => (
  <Layout>
    <Section.Container id="impressum">
      <Box color="white" width={[400, 600, 800]} m="auto">
        <h1>Impressum</h1>
        ...
        <h2>Kontakt</h2>
        <p>
          Telefon: 017620294381<br />
          E-Mail: gary.emekwa@web.de
        </p>
        ...
        <p>
          Unser Angebot enth&auml;lt Links zu externen Websites Dritter, auf deren Inhalte wir keinen Einfluss haben. Deshalb k&ouml;nnen wir f&uuml;r diese fremden Inhalte auch keine Gew&auml;hr &uuml;bernehmen. 
